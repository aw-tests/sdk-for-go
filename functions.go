...
// Create
func (srv *Functions) Create(Name string, Vars object, Events []interface{}, Schedule string, Timeout string) (map[string]interface{}, error) {
	path := "/functions"
...
// Update
func (srv *Functions) Update(FunctionId string, Name string, Vars object, Events []interface{}, Schedule string, Timeout string) (map[string]interface{}, error) {
	r := strings.NewReplacer("{functionId}", FunctionId)
	path := r.Replace("/functions/{functionId}")
